...
Quick-reference materials for the CompTIA Network+ N10-009 exam.
...
| File | Description |
|------|-------------|
| [common-ports.md](./common-ports.md) | Complete port/protocol reference table |
| [subnetting-cheatsheet.md](./subnetting-cheatsheet.md) | IPv4 subnetting quick reference |
| [cli-commands.md](./cli-commands.md) | Common CLI diagnostic and configuration commands |

---

## 🔗 Quick Links to Other Study Materials
